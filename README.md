...
MongoDB will be used to securely store user profiles, game results (wins, losses), and possibly rankings. The User Data Management API will handle CRUD (Create, Read, Update, Delete) operations on this data.
P1
As a player
